...
// My Hash - 14da9c0afc0e67d0ebb1ca9d66fce134fc1be0f0
...
async function searchHeros(textSearched) {
     ...
     await fetch(`https://gateway.marvel.com/v1/public/characters?nameStartsWith=${textSearched}&apikey=1737404381c071d811086e9e2be2987d&hash=14da9c0afc0e67d0ebb1ca9d66fce134fc1be0f0`)
...
function addToFavourites() {
     ...
     if (this.innerHTML == '<i class="fa-solid fa-heart fav-icon"></i> &nbsp; Add to Favourites') {
          ...
          // Adding the "wiggle" animation class to the button
          this.classList.add("wiggle-animation");

          // Removing the "wiggle" animation class after the animation ends
          this.addEventListener("animationend", function () {
               this.classList.remove("wiggle-animation");
          });
          ...
          // Deleting the "Added to Favourites" toast from DOM after 1 second
          setTimeout(function() {
     ...
     // For removing the character form favourites array
          ...
          const Rtoast = document.querySelector(".remove-toast");
          Rtoast.setAttribute("data-visiblity","show");
          Rtoast.classList.add("fade-in")

          // Deleting the "Remove from Favourites" toast from DOM after 1 seconds
          setTimeout(function(){
               Rtoast.classList.remove("fade-in")
               Rtoast.setAttribute("data-visiblity","hide");
          },1000);
     }     
}
